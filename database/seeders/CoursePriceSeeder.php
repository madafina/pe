...
class CoursePriceSeeder extends Seeder
{
    public function run(): void
    {
        ...
        CoursePrice::create(['course_id' => 3, 'price' => 3060000, 'name' => 'Gel. 1 (Juli-Sep)', 'registration_open_date' => '2025-03-01', 'registration_close_date' => '2025-09-30', 'payment_notes' => 'Pembayaran hingga Desember 2025', 'payment_deadline' => '2025-12-31']);
        CoursePrice::create(['course_id' => 4, 'price' => 3570000, 'name' => 'Gel. 1 (Juli-Sep)', 'registration_open_date' => '2025-03-01', 'registration_close_date' => '2025-09-30', 'payment_notes' => 'Pembayaran hingga Desember 2025', 'payment_deadline' => '2025-12-31']);
        ...
        CoursePrice::create(['course_id' => 3, 'price' => 2601000, 'name' => 'Gel. 2 (Okt-Nov)', 'registration_open_date' => '2025-10-01', 'registration_close_date' => '2025-11-30', 'payment_notes' => 'Pembayaran hingga Desember 2025', 'payment_deadline' => '2025-12-31']);
        CoursePrice::create(['course_id' => 4, 'price' => 3034500, 'name' => 'Gel. 2 (Okt-Nov)', 'registration_open_date' => '2025-10-01', 'registration_close_date' => '2025-11-30', 'payment_notes' => 'Pembayaran hingga Desember 2025', 'payment_deadline' => '2025-12-31']);
        ...
        CoursePrice::create(['course_id' => 3, 'price' => 2142000, 'name' => 'Gel. 3 (Des-Juni)', 'registration_open_date' => '2025-12-01', 'registration_close_date' => '2026-06-30', 'payment_notes' => 'Pembayaran hingga Februari 2026', 'payment_deadline' => '2026-02-28']);
        CoursePrice::create(['course_id' => 4, 'price' => 2499000, 'name' => 'Gel. 3 (Des-Juni)', 'registration_open_date' => '2025-12-01', 'registration_close_date' => '2026-06-30', 'payment_notes' => 'Pembayaran hingga Februari 2026', 'payment_deadline' => '2026-02-28']);
